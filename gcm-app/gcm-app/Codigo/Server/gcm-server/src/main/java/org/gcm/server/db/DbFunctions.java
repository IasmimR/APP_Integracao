...
public class DbFunctions {
     ...
     * @param list_user_id Lista com os ids dos usuários que farão parte do
     * grupo.
     * @return Objeto de resposta convertido em JSON de resposta informando true
     * em caso de sucesso.
     */
     ...
     *
     * @return Lista de {@code GcmUser} com todos os usuários presentes no
     * banco.
     */
    ...
    /**
     * Obtém todos os GCM ids dos usuários que estejam cadastrados em um
     * determinado grupo.
     *
