...
/**
 * Classe para enviar as requisições para o servidor GCM.
 *
...
public class GcmNotification {
    ...
    /**
     * Realiza o envio das notificações de mensagens ao servidor GCM.
     *
     * @param content Conteúdo para envio.
     * @return Mensagem de resposta recebida pelo servidor GCM.
     */
    public static String sendNotification(Content content) {
        ...
        try {
            ...
            System.out.println("\nEnviando uma requisição 'POST' a URL : " + url);
